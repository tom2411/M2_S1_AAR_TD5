...
* le driver JDBC MySQL pour accéder à la base (mysql:mysql-connector-java:5.1.44)
* le gestionnaire de persistence JPA, ici eclipseLink : org.eclipse.persistence:eclipselink:2.6.5
