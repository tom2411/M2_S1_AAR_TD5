...
les outils JPA proposés par IntelliJ/Eclipse JEE.
Nous allons tester l'implémentation de référence de JPA 2.2, EclipseLink, puis Hibernate.

* Pré-requis

Avoir un vrai SGBD installé, on utilisera MySQL(MySQL 5.X, X>0)

* Avec docker : https://hub.docker.com/_/mysql/
[source,bash]
...
. Ajoutez les annotations minimales aux classes
 ...
 Utilisez pour cela la refcardZ rc022-JPA_Online.pdf
